...
{
	/// <summary>
	/// Contains the details of a given request. These properties should all be mutable(可变的).
	...
	public interface IHttpRequestFeature
	{
		...
		/// in the original request, it is inferred(推断) by checking if the transport used a TLS
		/// connection or not.
		/// </summary>
		...
		/// <summary>
		/// The first portion(部分) of the request path associated with application root. The value
		/// is un-escaped. The value may be string.Empty.
		/// </summary>
		/// <remarks>关联根目录路径</remarks>
