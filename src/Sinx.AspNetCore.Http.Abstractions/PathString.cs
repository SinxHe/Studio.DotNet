...
namespace Sinx.AspNetCore.Http
{
	...
	/// </summary>
	/// <remarks>
	/// 为重新构建请求和重定向Url提供正确来自Path和PathBase的转义
	/// </remarks>
	public struct PathString : IEquatable<PathString>
	{
		...
		public string ToUriComponent()
		{
			...
			{
				if (PathStringHelper.IsValidPathChar(Value[i]))
				{
					if (requiresEscaping)
					{
		...
		public bool Equals(PathString other)	// implement from IEqualable<PathString>
		{
